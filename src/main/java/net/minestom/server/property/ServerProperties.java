...
public final class ServerProperties {
    ...
    public static final ServerProperty<Boolean> SUPPRESS_CONNECTION_ACCEPT_ERRORS = Boolean("minestom.suppress-connection-accept-errors", true);
    public static final ServerProperty<Boolean> SUPPRESS_CONNECTION_IO_ERRORS = Boolean("minestom.suppress-connection-io-errors", true); // Like peer resets etc
    public static final ServerProperty<Integer> SUPPRESS_MALFORMED_PACKET_ERROR_LEVEL = Integer("minestom.suppress-malformed-packet-error-level", 0); // Suppress packet read errors for states with ordinal at or below this level
    public static final ServerProperty<Integer> SUPPRESS_MISUSED_PACKET_ERROR_LEVEL = Integer("minestom.suppress-misused-packet-error-level", 0); // Suppress packet handling errors for states with ordinal at or below this level
    public static final ServerProperty<Boolean> REJECT_MALFORMED_PACKET = Boolean("minestom.reject-malformed-packet", true);
    public static final ServerProperty<Boolean> REJECT_MISUSED_PACKET = Boolean("minestom.reject-misused-packet", false);
    public static final ServerProperty<Boolean> WARN_PACKET_UNREAD_BYTES = Boolean("minestom.warn-packet-unread-bytes", true);
    ...
    @ApiStatus.Experimental
    public static final ServerProperty<Integer> NBT_MAX_BYTES = Integer("minestom.nbt.max-bytes", 2_097_152, 1, Integer.MAX_VALUE); // Approximate decoded heap usage, not encoded bytes
