...
final class DynamicRegistryImpl<T> implements DynamicRegistry<T> {
    private static final String UNSAFE_REMOVE_MESSAGE = "Registry is frozen. Create the process with registry freezing disabled, or set the system property 'minestom.registry.unsafe-ops' to 'true'";
