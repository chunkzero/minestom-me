...
public final class TickUtils {
    ...
    /**
     * Creates a number of ticks from a given duration, based on {@link Tick#SERVER_TICKS}.
     *
    ...
    public static int fromDuration(Duration duration) {
        return TickUtils.fromDuration(duration, Math.toIntExact(Tick.SERVER_TICKS.getDuration().toMillis()));
    }
