...
public class CommandSyntaxSingleTest {
    ...
    public void singleGroup() {
        ...
        // 1 2
        {
            var context = new CommandContext(process.commandManager(), "1 2", CommandContext.Purpose.PARSING);
    ...
    public void singleLoopGroup() {
        ...
        // 1 2 3 4
        {
            var context1 = new CommandContext(process.commandManager(), "1 2", CommandContext.Purpose.PARSING);
            var context2 = new CommandContext(process.commandManager(), "3 4", CommandContext.Purpose.PARSING);
    ...
    public void singleLoopDoubleGroup() {
        ...
        // block enchant
        {
            ...
            var context = new CommandContext(process.commandManager(), input, CommandContext.Purpose.PARSING);
        ...
        {
            var context1 = new CommandContext(process.commandManager(), "minecraft:allay minecraft:stone", CommandContext.Purpose.PARSING);
            var context2 = new CommandContext(process.commandManager(), "minecraft:grass_block minecraft:zombie", CommandContext.Purpose.PARSING);
    ...
    private static void assertSyntax(List<Argument<?>> args, String input, ExpectedExecution expectedExecution, @Nullable Map<String, Object> expectedValues) {
        ...
        var manager = process.commandManager();
