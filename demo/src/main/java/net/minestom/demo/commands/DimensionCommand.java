...
public class DimensionCommand extends Command {
    ...
    public DimensionCommand(ServerProcess process) {
        super("dimensiontest");
        ...
        addSyntax((sender, _) -> {
            ...
            final var instances = process.instance().getInstances().stream().filter(instance1 -> !instance1.equals(instance)).toList();
